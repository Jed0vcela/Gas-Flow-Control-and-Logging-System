...
/// Native fixed-size (compile-time) values used for buffer sizes
#define ILI9341_NATIVE_PIX_WIDTH  240
#define ILI9341_NATIVE_PIX_HEIGHT 320

// Hardwired rotation: set 0=0°, 1=90°, 2=180°, 3=270°.
// You can override this in your build flags: -DILI9341_ROTATION=1
#ifndef ILI9341_ROTATION
#define ILI9341_ROTATION 3
#endif

// Choose compile-time PIX_WIDTH / PIX_HEIGHT based on rotation.
// These must remain compile-time constants for static buffer sizes.
#if (ILI9341_ROTATION == 0) || (ILI9341_ROTATION == 2)
  #define PIX_WIDTH           ILI9341_NATIVE_PIX_WIDTH
  #define PIX_HEIGHT          ILI9341_NATIVE_PIX_HEIGHT
#else
  #define PIX_WIDTH           ILI9341_NATIVE_PIX_HEIGHT
  #define PIX_HEIGHT          ILI9341_NATIVE_PIX_WIDTH
#endif
